...
def ScanNLOCrossSectionTanBeta50(process):  
    ...
    process.seqScanNLOCrossSectionTanBeta50 = cms.Sequence(process.susyScanNLOCrossSection+process.susyScanNLOCrossSectionScale2+process.susyScanNLOCrossSectionScale05)
