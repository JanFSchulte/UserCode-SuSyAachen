...
def ScanNLOCrossSectionTanBeta3(process):  
    ...
    process.seqScanNLOCrossSectionTanBeta3 = cms.Sequence(process.susyScanNLOCrossSection+process.susyScanNLOCrossSectionScale2+process.susyScanNLOCrossSectionScale05)
