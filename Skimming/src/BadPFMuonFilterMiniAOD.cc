...
class BadPFMuonFilterMiniAOD : public edm::global::EDFilter<> {
public:
  explicit BadPFMuonFilterMiniAOD(const edm::ParameterSet&);
...
//
BadPFMuonFilterMiniAOD::BadPFMuonFilterMiniAOD(const edm::ParameterSet& iConfig)
...
BadPFMuonFilterMiniAOD::~BadPFMuonFilterMiniAOD() { }
...
bool
BadPFMuonFilterMiniAOD::filter(edm::StreamID iID, edm::Event& iEvent, const edm::EventSetup& iSetup) const
{
  using namespace std;
  using namespace edm;
...
DEFINE_FWK_MODULE(BadPFMuonFilterMiniAOD);
