...
class BadChargedCandidateFilterMiniAOD : public edm::global::EDFilter<> {
public:
  explicit BadChargedCandidateFilterMiniAOD(const edm::ParameterSet&);
...
//
BadChargedCandidateFilterMiniAOD::BadChargedCandidateFilterMiniAOD(const edm::ParameterSet& iConfig)
  : tokenPFCandidates_ ( consumes<edm::View<reco::Candidate> >(iConfig.getParameter<edm::InputTag> ("PFCandidates")  ))
  , tokenMuons_ ( consumes<edm::View<reco::Muon> >(iConfig.getParameter<edm::InputTag> ("src")  ))
...
BadChargedCandidateFilterMiniAOD::~BadChargedCandidateFilterMiniAOD() { }
...
bool
BadChargedCandidateFilterMiniAOD::filter(edm::StreamID iID, edm::Event& iEvent, const edm::EventSetup& iSetup) const
{
  using namespace std;
  using namespace edm;
...
DEFINE_FWK_MODULE(BadChargedCandidateFilterMiniAOD);
