...
HadronicTreesNoTaus = cms.EDAnalyzer("HadronicTrees",
...
HadronicTrees = HadronicTreesNoTaus.clone(
    taus = cms.InputTag("triggerMatchedPatTausPF"),
    tauId = cms.string("byTaNCfrHalfPercent"), 
    )

HadronicTreesForLMPoints = HadronicTrees.clone(
...
HadronicTreesmSugra = HadronicTrees.clone(
...
HadronicTreesSimplified = HadronicTrees.clone(
...
HadronicTreesSimplified.vertexWeights.doWeight=False
