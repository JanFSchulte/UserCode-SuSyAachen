...
SingleLeptonTreesNoTaus = cms.EDAnalyzer("SingleLeptonTrees",
...
SingleLeptonTrees = SingleLeptonTreesNoTaus.clone(
    taus = cms.InputTag("triggerMatchedPatTausPF"),
    tauId = cms.string("byTaNCfrHalfPercent"), 
    )

SingleLeptonTreesForLMPoints = SingleLeptonTrees.clone(
...
SingleLeptonTreesmSugra = SingleLeptonTrees.clone(
...
SingleLeptonTreesSimplified = SingleLeptonTrees.clone(
...
SingleLeptonTreesSimplified.vertexWeights.doWeight=False
