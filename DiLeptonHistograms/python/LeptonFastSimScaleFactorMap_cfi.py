...
LeptonFastSimScaleFactorMapPars2016 = cms.PSet(
    FastSimScaleFactorFile_mu_Id = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorMuonID.root'),
    FastSimScaleFactorFile_mu_Iso = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorMuonIso.root'),
    FastSimScaleFactorFile_mu_Impact = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorMuonIP2D.root'),
    FastSimScaleFactorFile_mu_SIP3D = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorMuonSIP3D.root'),
    
    FastSimScaleFactorFile_ele_Id = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorElectronID.root'),
    FastSimScaleFactorFile_ele_Iso = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorElectronIso.root'),
    FastSimScaleFactorFile_ele_ConvHit = cms.string('${CMSSW_BASE}/src/SuSyAachen/DiLeptonHistograms/data/2016/FastSimScaleFactorElectronIso.root'),
