...
HadronicAlphaTTreesNoTaus = cms.EDAnalyzer("HadronicAlphaTTrees",
...
HadronicAlphaTTrees = HadronicAlphaTTreesNoTaus.clone(
    taus = cms.InputTag("triggerMatchedPatTausPF"),
    tauId = cms.string("byTaNCfrHalfPercent"), 
    )

HadronicAlphaTTreesForLMPoints = HadronicAlphaTTrees.clone(
...
HadronicAlphaTTreesmSugra = HadronicAlphaTTrees.clone(
...
HadronicAlphaTTreesSimplified = HadronicAlphaTTrees.clone(
...
HadronicAlphaTTreesSimplified.vertexWeights.doWeight=False
