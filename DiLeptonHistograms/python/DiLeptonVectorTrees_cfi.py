...
DiLeptonVectorTreesNoTaus = cms.EDAnalyzer("DiLeptonVectorTrees",
...
DiLeptonVectorTrees = DiLeptonVectorTreesNoTaus.clone(
    taus = cms.InputTag("triggerMatchedPatTausPF"),
    tauId = cms.string("byTaNCfrHalfPercent"), 
    )

DiLeptonVectorTreesForLMPoints = DiLeptonVectorTrees.clone(
          pdfWeightTags = cms.VInputTag(
...
DiLeptonVectorTreesmSugra = DiLeptonVectorTrees.clone(
...
DiLeptonVectorTreesSimplified = DiLeptonVectorTrees.clone(
...
DiLeptonVectorTreesSimplified.vertexWeights.doWeight=False
