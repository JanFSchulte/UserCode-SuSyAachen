...
public:
  ...
  BTagEffMapFunctor( edm::ParameterSet const & params ){
            ...
            useFastSim_ = params.getParameter<bool>("useFastSim");
            ...
            if (useFastSim_) {
				std::string fileName_ = params.getParameter<std::string>("fastSimFile");
				std::string bEffName_ = params.getParameter<std::string>("bEffFastSimName");
				std::string cEffName_ = params.getParameter<std::string>("cEffFastSimName");
				std::string lightEffName_ = params.getParameter<std::string>("lightEffFastSimName");
			}
