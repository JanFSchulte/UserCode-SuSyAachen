...
PdgIdFunctor::operator()(const T& lepton)
{
  ...
  double minDR = 999.;
  double deltaR = 0.;
  const reco::GenParticle * matchedGenPart;
  const reco::GenParticle * matchedGenPartMother;
  const reco::GenParticle * matchedGenPartGrandMother;  
  bool matched = false;
  ...
  matchedGenPart = nullptr;
  matchedGenPartMother = nullptr;
  matchedGenPartGrandMother = nullptr;
  res.push_back(pdgId);
