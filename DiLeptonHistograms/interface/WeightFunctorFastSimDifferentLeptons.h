/*
 * WeightFunctorFastSimDifferentLeptons.h
 *
 *  Created on: 21.12.2010
 *      Author: heron
 */

#ifndef WEIGHTFUNCTORFASTSIMDIRRENTLEPTONS_H_
#define WEIGHTFUNCTORFASTSIMDIFFERENTLEPTONS_H_
...
class WeightFunctorFastSimDifferentLeptons
{
public:
	WeightFunctorFastSimDifferentLeptons();
	void SetSource( const edm::ParameterSet& p, const std::string name, const bool mc=false);
	template<class T,class T2> double operator()(const T& lepton, const T2& lepton2, unsigned int& nJets,const std::string mode, const std::string type);
// 	double operator()(const pat::Electron& lepton,const pat::Electron& lepton2,const double nJets){return this->operator()(lepton,lepton2,nJets, "dielectrons");};
	double operator()(const pat::Electron& lepton,const pat::Muon& lepton2,unsigned int& nJets,const std::string mode){return this->operator()(lepton,lepton2,nJets,mode, "electronmuons");};
	double operator()(const pat::Electron& lepton,const pat::Tau& lepton2,unsigned int& nJets,const std::string mode){return this->operator()(lepton,lepton2,nJets,mode, "electrontaus");};
	double operator()(const pat::Muon& lepton,const pat::Tau& lepton2,unsigned int& nJets,const std::string mode){return this->operator()(lepton,lepton2,nJets,mode, "muontaus");};
...
double
WeightFunctorFastSimDifferentLeptons::operator()(const T& lepton, const T2& lepton2,unsigned int& nJets,const std::string mode, const std::string type)
{
	double result = 1.0;
...
#endif /* WEIGHTFUNCTORFASTSIMDIFFERENTLEPTONS_H_ */
