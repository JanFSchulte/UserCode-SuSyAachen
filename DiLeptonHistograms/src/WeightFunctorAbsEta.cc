...
void
WeightFunctorAbsEta::SetSource( const edm::ParameterSet& p, const std::string rawName, const bool mc )
{
...
bool
WeightFunctorAbsEta::isInBin(const edm::ParameterSet& p, const std::string name, double value)
{
	bool result = false;
