...
float DiLeptonTriggerTrees::getId(const  pat::Electron &e)
{
  //  if (e.isEE())
...
float DiLeptonTriggerTrees::getId(const  pat::Muon &mu)
{
...
float DiLeptonTriggerTrees::getId(const  pat::Tau &tau)
{
