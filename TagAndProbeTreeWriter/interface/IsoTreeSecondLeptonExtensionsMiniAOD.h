...
class IsoTreeSecondLeptonExtensionsMiniAOD
{
public:
	IsoTreeSecondLeptonExtensionsMiniAOD(){debug_=false;};
...
void IsoTreeSecondLeptonExtensionsMiniAOD::init(const edm::ParameterSet& iConfig, TTree& tree)
{
...
template< typename T >
void IsoTreeSecondLeptonExtensionsMiniAOD::fill(TTree& tree, const T& lepton, const edm::Event& iEvent)
{
...
int IsoTreeSecondLeptonExtensionsMiniAOD::getDileptonCount(const T& lepton, const std::vector<U>& secondLeptons, const bool oppositeSign, const int leptonKind)
{
	int result = 0;
