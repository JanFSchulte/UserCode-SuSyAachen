...
class IsoTreeTauExtensionsMiniAOD
{
public:
	IsoTreeTauExtensionsMiniAOD(){debug_=false;};
...
void IsoTreeTauExtensionsMiniAOD::init(const edm::ParameterSet& iConfig, TTree& tree)
{
...
void IsoTreeTauExtensionsMiniAOD::fill(TTree& tree, const pat::Tau& tau)
{
...
int IsoTreeTauExtensionsMiniAOD::trueDecayMode( const reco::Candidate& p)
{
	int result = 0;
	if(p.pdgId() == 111)
		result = 1;
