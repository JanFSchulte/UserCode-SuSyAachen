...
class IsoTreeEventFootprintExtensionsMiniAOD
{
 public:
  IsoTreeEventFootprintExtensionsMiniAOD(){debug_=false;};
...
void IsoTreeEventFootprintExtensionsMiniAOD::init(const edm::ParameterSet& iConfig, TTree& tree)
{
...
void IsoTreeEventFootprintExtensionsMiniAOD::fill(const edm::Event& iEvent)
{
